...
SpectraPreProcess<-function(rawspectra,SmLn=3,SmMn=5,SmHn=11, ExtraDerivativeLSm=15, ExtraDerivativeHSm=17){
  ...
  D1SHUvn<-apply(D1SH,1,spec4ml::uvnormalize);colnames(D1SHUvn$spc)<-colnames(rawspectra$spc)#added in the version 2 (24/5)
  D1SLUvn<-apply(D1SL,1,spec4ml::uvnormalize);colnames(D1SLUvn$spc)<-colnames(rawspectra$spc)#added in the version 2 (24/5)
  D2SHUvn<-apply(D2SH,1,spec4ml::uvnormalize);colnames(D2SHUvn$spc)<-colnames(rawspectra$spc)#added in the version 2 (24/5)
  D2SLUvn<-apply(D2SL,1,spec4ml::uvnormalize);colnames(D2SLUvn$spc)<-colnames(rawspectra$spc)#added in the version 2 (24/5)
