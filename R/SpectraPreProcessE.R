...
SpectraPreProcessE<-function(rawspectra,SmLn=3,SmMn=5,SmHn=11){
  ...
  ##Snv
  Snv<-spec4ml::snvh(rawspectra)
  SmMSnv<-spec4ml::snvh(SmM)
  SmHSnv<-spec4ml::snvh(SmH)
  SmLSnv<-spec4ml::snvh(SmL)
  ##EMSC
  Emsc<-spec4ml::emsch(rawspectra)
  SmMEmsc<-spec4ml::emsch(SmM)
  SmHEmsc<-spec4ml::emsch(SmH)
  SmLEmsc<-spec4ml::emsch(SmL)
  ##Baseline
  ...
  #Normalize
  Uvn<-apply(rawspectra,1,spec4ml::uvnormalize);colnames(Uvn$spc)<-colnames(rawspectra$spc)
  SmMUvn<-apply(SmM,1,spec4ml::uvnormalize);colnames(SmMUvn$spc)<-colnames(rawspectra$spc)
  SmLUvn<-apply(SmL,1,spec4ml::uvnormalize);colnames(SmLUvn$spc)<-colnames(rawspectra$spc)
  SmHUvn<-apply(SmH,1,spec4ml::uvnormalize);colnames(SmHUvn$spc)<-colnames(rawspectra$spc)
  SnvUvn<-apply(Snv,1,spec4ml::uvnormalize);colnames(SnvUvn$spc)<-colnames(rawspectra$spc)
  SmLSnvUvn<-apply(SmLSnv,1,spec4ml::uvnormalize);colnames(SmLSnvUvn$spc)<-colnames(rawspectra$spc)
  SmMSnvUvn<-apply(SmMSnv,1,spec4ml::uvnormalize);colnames(SmMSnvUvn$spc)<-colnames(rawspectra$spc)
  SmHSnvUvn<-apply(SmHSnv,1,spec4ml::uvnormalize);colnames(SmHSnvUvn$spc)<-colnames(rawspectra$spc)
  EmscUvn<-apply(Emsc,1,spec4ml::uvnormalize);colnames(EmscUvn$spc)<-colnames(rawspectra$spc)
  SmLEmscUvn<-apply(SmLEmsc,1,spec4ml::uvnormalize);colnames(SmLEmscUvn$spc)<-colnames(rawspectra$spc)
  SmMEmscUvn<-apply(SmMEmsc,1,spec4ml::uvnormalize);colnames(SmMEmscUvn$spc)<-colnames(rawspectra$spc)
  SmHEmscUvn<-apply(SmHEmsc,1,spec4ml::uvnormalize);colnames(SmHEmscUvn$spc)<-colnames(rawspectra$spc)
  blUvn<-apply(bl,1,spec4ml::uvnormalize);colnames(blUvn$spc)<-colnames(bl$spc)
  SmMblUvn<-apply(SmMbl,1,spec4ml::uvnormalize);colnames(SmMblUvn$spc)<-colnames(bl$spc)
  SmLblUvn<-apply(SmLbl,1,spec4ml::uvnormalize);colnames(SmLblUvn$spc)<-colnames(bl$spc)
  SmHblUvn<-apply(SmHbl,1,spec4ml::uvnormalize);colnames(SmHblUvn$spc)<-colnames(bl$spc)
  EmscblUvn<-apply(Emscbl,1,spec4ml::uvnormalize);colnames(EmscblUvn$spc)<-colnames(bl$spc)
  SmMEmscblUvn<-apply(SmMEmscbl,1,spec4ml::uvnormalize);colnames(SmMEmscblUvn$spc)<-colnames(bl$spc)
  SmLEmscblUvn<-apply(SmLEmscbl,1,spec4ml::uvnormalize);colnames(SmLEmscblUvn$spc)<-colnames(bl$spc)
  SmHEmscblUvn<-apply(SmHEmscbl,1,spec4ml::uvnormalize);colnames(SmHEmscblUvn$spc)<-colnames(bl$spc)
  D1S3Uvn<-apply(D1S3,1,spec4ml::uvnormalize);colnames(D1S3Uvn$spc)<-colnames(rawspectra$spc)
  D1S9Uvn<-apply(D1S9,1,spec4ml::uvnormalize);colnames(D1S9Uvn$spc)<-colnames(rawspectra$spc)
  D2S11Uvn<-apply(D2S11,1,spec4ml::uvnormalize);colnames(D2S11Uvn$spc)<-colnames(rawspectra$spc)

  SmMD1S9Uvn<-apply(SmMD1S9,1,spec4ml::uvnormalize);colnames(SmMD1S9Uvn$spc)<-colnames(rawspectra$spc)
  SmMD1S3Uvn<-apply(SmMD1S3,1,spec4ml::uvnormalize);colnames(SmMD1S3Uvn$spc)<-colnames(rawspectra$spc)
  SmLD1S9Uvn<-apply(SmLD1S9,1,spec4ml::uvnormalize);colnames(SmLD1S9Uvn$spc)<-colnames(rawspectra$spc)
  SmLD1S3Uvn<-apply(SmLD1S3,1,spec4ml::uvnormalize);colnames(SmLD1S3Uvn$spc)<-colnames(rawspectra$spc)
  SmHD1S9Uvn<-apply(SmHD1S9,1,spec4ml::uvnormalize);colnames(SmHD1S9Uvn$spc)<-colnames(rawspectra$spc)
  SmHD1S3Uvn<-apply(SmHD1S3,1,spec4ml::uvnormalize);colnames(SmHD1S3Uvn$spc)<-colnames(rawspectra$spc)
  SmLD2S3Uvn<-apply(SmLD2S3,1,spec4ml::uvnormalize);colnames(SmLD2S3Uvn$spc)<-colnames(rawspectra$spc)
  SmLD2S11Uvn<-apply(SmLD2S11,1,spec4ml::uvnormalize);colnames(SmLD2S11Uvn$spc)<-colnames(rawspectra$spc)
  SmMD2S3Uvn<-apply(SmMD2S3,1,spec4ml::uvnormalize);colnames(SmMD2S3Uvn$spc)<-colnames(rawspectra$spc)
  SmMD2S11Uvn<-apply(SmMD2S11,1,spec4ml::uvnormalize);colnames(SmMD2S11Uvn$spc)<-colnames(rawspectra$spc)
  SmHD2S3Uvn<-apply(SmHD2S3,1,spec4ml::uvnormalize);colnames(SmHD2S3Uvn$spc)<-colnames(rawspectra$spc)
  SmHD2S11Uvn<-apply(SmHD2S11,1,spec4ml::uvnormalize);colnames(SmHD2S11Uvn$spc)<-colnames(rawspectra$spc)
