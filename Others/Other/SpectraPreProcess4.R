...
SpectraPreProcess3<-function(rawspectra,SmLn=3,SmMn=5,SmHn=11){
  ####SMs######
  library(hyperSpec)
  ...
  SmM<-apply(rawspectra,1,pracma::savgol,fl=SmMn, forder = 2, dorder = 0);hyperSpec::colnames(SmM$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmH<-apply(rawspectra,1,pracma::savgol,fl=SmHn, forder = 2, dorder = 0);hyperSpec::colnames(SmH$spc)<-hyperSpec::colnames(rawspectra$spc)
  ##Snv
  Snv<-snvh(rawspectra)
  SmMSnv<-snvh(SmM)
  SmHSnv<-snvh(SmH)
  ...
  SmMD1S9<-apply(SmM,1,pracma::savgol,fl=9, forder = 2, dorder = 1);hyperSpec::colnames(SmMD1S9$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmMD1S3<-apply(SmM,1,pracma::savgol,fl=3, forder = 2, dorder = 1);hyperSpec::colnames(SmMD1S3$spc)<-hyperSpec::colnames(rawspectra$spc)
  ...
  SmHD1S9<-apply(SmH,1,pracma::savgol,fl=9, forder = 2, dorder = 1);hyperSpec::colnames(SmHD1S9$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmHD1S3<-apply(SmH,1,pracma::savgol,fl=3, forder = 2, dorder = 1);hyperSpec::colnames(SmHD1S3$spc)<-hyperSpec::colnames(rawspectra$spc)
  ##2nDev
  ...
  SmMD2S3<-apply(SmM,1,pracma::savgol,fl=3, forder = 2, dorder = 2);hyperSpec::colnames(SmMD2S3$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmMD2S11<-apply(SmM,1,pracma::savgol,fl=11, forder = 2, dorder = 2);hyperSpec::colnames(SmMD2S11$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmHD2S3<-apply(SmH,1,pracma::savgol,fl=3, forder = 2, dorder = 2);hyperSpec::colnames(SmHD2S3$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmHD2S11<-apply(SmH,1,pracma::savgol,fl=11, forder = 2, dorder = 2);hyperSpec::colnames(SmHD2S11$spc)<-hyperSpec::colnames(rawspectra$spc)
  #Normalize
  Uvn<-apply(rawspectra,1,uvnormalize);hyperSpec::colnames(Uvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmMUvn<-apply(SmM,1,uvnormalize);hyperSpec::colnames(SmMUvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmLUvn<-apply(SmL,1,uvnormalize);hyperSpec::colnames(SmLUvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmHUvn<-apply(SmH,1,uvnormalize);hyperSpec::colnames(SmHUvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  ...
  SmMSnvUvn<-apply(SmMSnv,1,uvnormalize);hyperSpec::colnames(SmMSnvUvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmHSnvUvn<-apply(SmHSnv,1,uvnormalize);hyperSpec::colnames(SmHSnvUvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  ...
  SmMEmscUvn<-apply(SmMEmsc,1,uvnormalize);hyperSpec::colnames(SmMEmscUvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmHEmscUvn<-apply(SmHEmsc,1,uvnormalize);hyperSpec::colnames(SmHEmscUvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  blUvn<-apply(bl,1,uvnormalize);hyperSpec::colnames(blUvn$spc)<-hyperSpec::colnames(bl$spc)
  SmMblUvn<-apply(SmMbl,1,uvnormalize);hyperSpec::colnames(SmMblUvn$spc)<-hyperSpec::colnames(bl$spc)
  SmLblUvn<-apply(SmLbl,1,uvnormalize);hyperSpec::colnames(SmLblUvn$spc)<-hyperSpec::colnames(bl$spc)
  SmHblUvn<-apply(SmHbl,1,uvnormalize);hyperSpec::colnames(SmHblUvn$spc)<-hyperSpec::colnames(bl$spc)
  EmscblUvn<-apply(Emscbl,1,uvnormalize);hyperSpec::colnames(EmscblUvn$spc)<-hyperSpec::colnames(bl$spc)
  SmMEmscblUvn<-apply(SmMEmscbl,1,uvnormalize);hyperSpec::colnames(SmMEmscblUvn$spc)<-hyperSpec::colnames(bl$spc)
  SmLEmscblUvn<-apply(SmLEmscbl,1,uvnormalize);hyperSpec::colnames(SmLEmscblUvn$spc)<-hyperSpec::colnames(bl$spc)
  SmHEmscblUvn<-apply(SmHEmscbl,1,uvnormalize);hyperSpec::colnames(SmHEmscblUvn$spc)<-hyperSpec::colnames(bl$spc)
  ...
  SmMD1S9Uvn<-apply(SmMD1S9,1,uvnormalize);hyperSpec::colnames(SmMD1S9Uvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmMD1S3Uvn<-apply(SmMD1S3,1,uvnormalize);hyperSpec::colnames(SmMD1S3Uvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  ...
  SmHD1S9Uvn<-apply(SmHD1S9,1,uvnormalize);hyperSpec::colnames(SmHD1S9Uvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmHD1S3Uvn<-apply(SmHD1S3,1,uvnormalize);hyperSpec::colnames(SmHD1S3Uvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  ...
  SmMD2S3Uvn<-apply(SmMD2S3,1,uvnormalize);hyperSpec::colnames(SmMD2S3Uvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmMD2S11Uvn<-apply(SmMD2S11,1,uvnormalize);hyperSpec::colnames(SmMD2S11Uvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmHD2S3Uvn<-apply(SmHD2S3,1,uvnormalize);hyperSpec::colnames(SmHD2S3Uvn$spc)<-hyperSpec::colnames(rawspectra$spc)
  SmHD2S11Uvn<-apply(SmHD2S11,1,uvnormalize);hyperSpec::colnames(SmHD2S11Uvn$spc)<-hyperSpec::colnames(rawspectra$spc)
